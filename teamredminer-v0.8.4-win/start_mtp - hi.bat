...
::
:: Example:
"C:\Users\Christian Hinkle\Documents\Mining\teamredminer-v0.8.4-win\teamredminer.exe" -a mtp -o stratum+tcp://us-firo.2miners.com:8181 -u aAArbqdnXfBBa75VEAWGP4rgm8hitTDuXb.PersonalDesktop -p x
