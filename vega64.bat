...
"teamredminer-v0.8.5-win\teamredminer.exe" -a autolykos2 -o stratum+tcp://us.ergo.herominers.com:10250 -u 9fc314ndVamV3dcBQ38nBN2WzcgeTeyeC9MzQfu7WmFHf4V3XK7.FxBoi -p x  --temp_limit=90
